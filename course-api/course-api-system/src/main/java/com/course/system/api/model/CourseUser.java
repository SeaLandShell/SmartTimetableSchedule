package com.course.system.api.model;
...
public class CourseUser extends BaseEntity
{
    ...
    public void setStuTuNumber(String stuTuNumber)
    {
        this.stuTuNumber = stuTuNumber;
    }

    public String getStuTuNumber()
    {
        return stuTuNumber;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("stuTuNumber", getStuTuNumber())
            .append("sex", getSex())
