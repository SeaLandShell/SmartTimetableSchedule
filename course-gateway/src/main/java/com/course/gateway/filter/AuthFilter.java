...
import com.course.common.core.constant.HttpStatus;
...
import com.course.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered
{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain)
    {
        ...
        String userphone= JwtUtils.getUserPhoneNumber(claims);
        ...
        addHeader(mutate, SecurityConstants.DETAILS_USERPHONE, userphone);
        // 内部请求来源参数清除
