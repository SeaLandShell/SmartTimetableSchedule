...
public class CreateCollectionService {
    ...
    public Object createCollections() {
        // 创建第一个集合 "resourcesNoLimit"
        String collectionName1 = "resourcesNoLimit";
        mongoTemplate.createCollection(collectionName1);
        // 检测第一个集合是否存在，并记录创建结果
        String result1 = mongoTemplate.collectionExists(collectionName1) ? "创建视图成功" : "创建视图失败";

        // 创建第二个集合 "uploadNoLimit"
        String collectionName2 = "uploadNoLimit";
        mongoTemplate.createCollection(collectionName2);
        // 检测第二个集合是否存在，并记录创建结果
        String result2 = mongoTemplate.collectionExists(collectionName2) ? "创建视图成功" : "创建视图失败";

        // 返回两个集合创建结果
        return "resourcesNoLimit: " + result1 + ", uploadNoLimit: " + result2;
    }
...
//        // 设置集合名称
//        String collectionName = "resourcesLimit";
//        // 设置集合参数
//        long size = 1024L;
//        long max = 5L;
//        // 创建固定大小集合
