...
import com.app.ctimetable.utils.OkHttpUtils;
...
public class CSUCollege implements College {
    ...
    public static final String NAME = "暂未支持其他学校";
    ...
    @Override
    public Request createRequestWithCookie(String url, String cookie) {
        return College.super.createRequestWithCookie(url, cookie);
    }
}
