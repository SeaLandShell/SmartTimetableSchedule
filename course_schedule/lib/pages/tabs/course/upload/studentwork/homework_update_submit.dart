...
class HomeworkUpdateSubmitPage extends StatefulWidget {
  final Schedule schedule;
  final Upload upload;
  const HomeworkUpdateSubmitPage({super.key,required this.schedule,required this.upload});

  @override
  State<HomeworkUpdateSubmitPage> createState() => _HomeworkUpdateSubmitPageState();
}

class _HomeworkUpdateSubmitPageState extends State<HomeworkUpdateSubmitPage> {
  /// 内容距状态栏的高度
            ...
            GestureDetector(
              ...
              child: const SizedBox( // 使用SizedBox设置Tab的宽度
                ...
                child: Row(children: [
                  ...
                  Text("再次提交",style: TextStyle(color: Colors.black,fontSize: 16),),
                ]),
              ),
            ),
        ],
