...
-- 删除外键约束
-- 判断外键是否存在，如果存在则删除
-- ALTER TABLE `calendar` DROP FOREIGN KEY `fk_calendar_t_user_1`;
-- ALTER TABLE `t_member` DROP FOREIGN KEY `fk_t_member_t_user_1`;
-- ALTER TABLE `t_member` DROP FOREIGN KEY `fk_t_member_t_course_1`;
-- ALTER TABLE `t_notice` DROP FOREIGN KEY `fk_t_notice_t_course_1`;
-- ALTER TABLE `t_resource` DROP FOREIGN KEY `fk_t_resource_t_course_1`;
-- ALTER TABLE `t_course` DROP FOREIGN KEY `fk_t_course_t_user_1`;
-- ALTER TABLE `t_work` DROP FOREIGN KEY `fk_t_work_t_course_1`;
-- ALTER TABLE `t_upload` DROP FOREIGN KEY `fk_t_upload_t_user_1`;
-- ALTER TABLE `t_upload` DROP FOREIGN KEY `fk_t_upload_t_work_1`;
-- ALTER TABLE `t_log` DROP FOREIGN KEY `fk_t_log_t_user_1`;
-- ALTER TABLE `t_mnotice` DROP FOREIGN KEY `fk_t_mnotice_t_course_1`;

-- 添加外键约束
-- ALTER TABLE `calendar_table` ADD CONSTRAINT `fk_calendar_table_t_user_1` FOREIGN KEY (`user_id`) REFERENCES `course_user` (`user_id`);
